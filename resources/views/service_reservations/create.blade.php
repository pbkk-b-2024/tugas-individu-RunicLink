...
@section('title', 'Add Service Reservation')

@section('content')
<div class="container mt-5">
    <h1>Add Service Reservation</h1>
    <form action="{{ route('service_reservations.store') }}" method="POST">
        @csrf
        ...
        <button type="submit" class="btn btn-primary">Add Service Reservation</button>
    </form>
</div>
@endsection
